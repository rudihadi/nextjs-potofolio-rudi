...
export default function Navbar() {
  ...
  return (
    <Disclosure
      as="nav"
      className="relative items-center px-6 py-4 border-b shadow-sm bg-background text-foreground"
      style={{ height: "10vh" }}
    >
        ...
        <div className="relative flex h-8 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
              <Link
                href={"/"}
                className={`${grechen.className} font-bold text-3xl hover:text-blue-600 dark:hover:text-blue-400`}
              >
                RUDI HADI
              </Link>
            </div>
                  ...
                  return (
                    <Link
                      ...
                      className={classNames(
                        ...
                        "font-semibold rounded-md px-3 py-2 text-xl hover:text-blue-600 dark:hover:text-blue-400"
                      )}
                    >
                      {item.name}
                    </Link>
            ...
            return (
              <DisclosureButton
                ...
                className={classNames(
                  ...
                  "block rounded-md px-3 py-2 text-base font-medium hover:text-blue-600 dark:hover:text-blue-400"
                )}
              >
                {item.name}
              </DisclosureButton>
